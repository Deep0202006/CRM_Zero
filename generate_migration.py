...
sql_content = """-- ZeroData CRM — Final Team KPI and Work-Persistence Root Repair
...
with open('supabase/migrations/030_team_kpi_durable_work_system.sql', 'w', encoding='utf-8') as f:
    f.write(sql_content)

print("Migration 030 created.")
