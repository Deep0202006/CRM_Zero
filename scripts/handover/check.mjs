...
assert.doesNotThrow(() => migrationBoundary(root));
assert.deepEqual(validateMigrationBoundary({ lastAppliedOwnerMigration: 51, immutableThrough: 51 }), { lastAppliedOwnerMigration: 51, immutableThrough: 51 });
