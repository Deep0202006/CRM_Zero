...
create table public.call_logs(id uuid primary key);
create table public.attendance(id uuid primary key);
create table public.field_visits(id uuid primary key);
create table public.tasks(id uuid primary key);
create table public.receivables(id uuid primary key);
create table public.receivable_payments(id uuid primary key);
