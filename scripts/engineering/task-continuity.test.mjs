...
try {
  ...
  gitAt(fixture, "config", "user.name", "CRM Hook Fixture"); gitAt(fixture, "config", "user.email", "fixture@example.invalid"); gitAt(fixture, "add", "scripts/engineering", "docs/engineering", "docs/contracts/engineering-os.md", "package.json", "AGENTS.md"); gitAt(fixture, "commit", "-m", "test: current V6A hook fixture");
