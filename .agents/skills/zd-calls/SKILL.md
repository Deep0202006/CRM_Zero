...
Checks: no delete/clear, approved confirmation API, stable retry ID/idempotency key, exact queue removal only after confirmation, UUID/text identity separation, canonical employee/Admin counts.
