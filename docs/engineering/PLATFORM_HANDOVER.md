...
Concrete readiness authority is [the handover contract](../handover/README.md), enforced by proof `supabase-handover-readiness`. [Owner gates](../handover/owner-gates.json) keep rehearsal, cutover, and source decommission as separate external decisions; parity evidence never synthesizes approval.
