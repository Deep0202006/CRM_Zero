...
export async function GET(request: Request) {
  ...
  const operation = query.view === "metrics"
    ...
    : query.view === "list"
      ? context.service.rpc("distributor_renewals_list_v1", { p_actor_id: context.userId, p_admin: context.isAdmin, p_filter: query.filter, p_page: query.page, p_page_size: query.pageSize })
      : context.service.rpc("distributor_renewals_due_v1", { p_actor_id: context.userId, p_admin: context.isAdmin, p_limit: query.limit });
