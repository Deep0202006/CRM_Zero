...
export default function NewRetailerVisitPage() {
  ...
  const outcomes = [
    { label: "New Registration", value: "registered" },
    { label: "Interested (Active/Usage)", value: "interested" },
    { label: "Follow-up Required (Closed/Not Available/Issue)", value: "follow_up" },
