...
export const mappingRequestSchema = z.object({
  ...
  mapped_by: uuidSchema.optional().nullable(),
  requested_by_id_snapshot: uuidSchema.optional().nullable(),
  mapped_by_id_snapshot: uuidSchema.optional().nullable(),
  requested_by_name_snapshot: z.string().optional().nullable(),
  mapped_by_name_snapshot: z.string().optional().nullable(),
